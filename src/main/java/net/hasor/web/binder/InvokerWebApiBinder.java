...
public class InvokerWebApiBinder extends ApiBinderWrap implements WebApiBinder {
    private final InstanceProvider<String> requestEncoding  = new InstanceProvider<>("UTF-8");
    private final InstanceProvider<String> responseEncoding = new InstanceProvider<>("UTF-8");
